...
export interface Page {
  ...
  layout: (BannerBlock | CallToActionBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock)[];
  meta?: {
    title?: string | null;
    /**
...
export interface Order {
  ...
  orderItems: {
    /**
     * Field will turn red if stock is insufficient
     */
    product: string | Product;
    quantity: number;
    /**
     * Automatically populated from product
     */
    unitPrice: number;
...
export interface Customer {
  ...
  email?: string | null;
  phone?: string | null;
  customerType: 'retail' | 'business' | 'wholesale';
  billingAddress?: {
    street?: string | null;
    zipCode?: string | null;
    city?: string | null;
  ...
  paymentTerms?: {
    method?: ('invoice' | 'directDebit' | 'creditCard') | null;
...
export interface Revenue {
  ...
  category: 'products' | 'services' | 'subscriptions' | 'other';
  costs?: number | null;
  profit?: number | null;
  tax?: number | null;
  notes?: string | null;
